...
module.exports = {
  async createDonation(donation) {
    return await sql`
        INSERT INTO donations (donor_name, email, phone_number, collection_address,  description)
        VALUES (${donation.donor_name}, ${donation.email}, ${donation.phone_number}, ${donation.collection_address}, ${donation.description})
        RETURNING *
        `;
  },
